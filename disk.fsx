...
module DiskOption =
    ...
    let seekRecord disk =
        match disk with
        | { DiskType = DiskType.HardDisk
            RPM = Some 5400
            Platters = Some 5
            NumberOfPins = _ } -> printfn "Seeking loudly and slowly!"
        | { DiskType = DiskType.HardDisk
            RPM = _
            Platters = Some 7
            NumberOfPins = _ } -> printfn "Seeking loudly but quickly!"
        ...
        | { DiskType = DiskType.SSD
            RPM = _
            Platters = _
            NumberOfPins = _ } -> printfn "Already found it!"
...
module DiskUnion =
    ...
    let seekRecord disk =
        ...
        | { DiskType = DiskType.HardDisk
            RPM = 5400
            Platters = _
            NumberOfPins = 5 } -> printfn "Seeking loudly and slowly!"
        | { DiskType = DiskType.HardDisk
            RPM = _
            Platters = 7
            NumberOfPins = 23 } -> printfn "Seeking loudly but quickly!"
        | { DiskType = DiskType.MMC
            RPM = _
            Platters = _
