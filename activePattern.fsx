...
let calculatePoints3 (expected: Score) (actual: Score) =
    [ resultScore; goalsScore2 ] |> List.sumBy (fun f -> f expected actual)

let assertnoScoreDrawCorrect2 = calculatePoints3 (0, 0) (0, 0) = 400
let assertHomeWinExactMatch2 = calculatePoints3 (3, 2) (3, 2) = 485
let assertHomeWin2 = calculatePoints3 (5, 1) (4, 3) = 180
let assertIncorrect2 = calculatePoints3 (2, 1) (0, 7) = 20
let assertDraw2 = calculatePoints3 (2, 2) (3, 3) = 170
